...
const DashboardHeader = async () => {
  return (
    <SidebarHeader className="pointer-events-none fixed top-0 z-50 flex h-14 w-full flex-row justify-between border-b bg-background p-0 sm:sticky sm:h-8.75 sm:border-b-0 sm:bg-transparent">
