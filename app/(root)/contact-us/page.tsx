                    ...
                    {contactMethods.map((method) => {
                      ...
                      return (
                        <a
                          ...
                          href={method.href}
                          target={
                            method.id === "address" ? "_blank" : undefined
                          }
                          rel={
                            method.id === "address"
                              ? "noopener noreferrer"
              ...
              <div className="flex gap-5">
                ...
                <div className="flex-1">
                  ...
                  <div className="mt-5 flex flex-col gap-3 text-sm leading-7 text-muted-foreground">
                    <p>
                      Standard support is available Saturday to Thursday, 10:00
                      AM to 7:00 PM Bangladesh time. Emergency travel requests
                      should include a phone number so the team can prioritize
                      the response.
                    </p>
