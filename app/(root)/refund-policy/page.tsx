          ...
          <article className="min-w-0">
            ...
            <div className="flex gap-5">
              ...
              <p className="pb-10 text-[1rem] leading-[1.85] text-muted-foreground">
                We are committed to providing the best products and support to
                our customers. Please read our refund policy below to understand
                how we handle refunds for digital products and subscriptions.
              </p>
            </div>
